...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 17 déc. 2019 à 09:06
...
--
CREATE DATABASE IF NOT EXISTS `payfriends` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `payfriends`;
...
(21, 'Raclette', 'Samedi', 'iepepe9m5z15');
...
('root', '[{\"db\":\"payfriends\",\"table\":\"members\"},{\"db\":\"payfriends\",\"table\":\"events\"},{\"db\":\"payfriends\",\"table\":\"users\"}]');
...
('root', '2019-12-17 08:06:06', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
