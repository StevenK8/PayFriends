<?php
header("Access-Control-Allow-Origin: https://stevenkerautret.com");
          ...
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" min="1" aria-label="Prix" placeholder="Prix"
                  name="prixDepense">
              ...
              <div class="form-check form-check-info">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" checked=""> Tous
                  les membres <i class="input-helper"></i></label>
              </div>
              <div class="form-check form-check-info">
                <label class="form-check-label">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item <?php echo isset($_GET["id"])?"active":"" ?>">
            <a class="<?php echo isset($_GET["id"])?"nav-link":"nav-link collapsed" ?>" data-toggle="collapse"
              href="#ui-basic" aria-expanded="<?php echo isset($_GET["id"])?"true":"false" ?>" aria-controls="ui-basic">
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <a class="nav-link" href="pages/forms/newEvent.php">
                <button class="btn btn-block btn-lg btn-gradient-primary mt-4" id="newEvent"><i
                    class="mdi mdi-plus-circle-multiple-outline mdi-24px float-center"></i><br>Nouvel Evénement</button>
              </a>
            </span>
          </li>
        </ul>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Vos dépenses <i
                      class="mdi mdi-currency-eur mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5">
                    <?php
                      if(isset($_GET["id"])){
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Participants <i
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Projet Developpement Web 2020
                - <a href="http://www.polytech.u-psud.fr/fr/index.html" target="_blank">Polytech Paris-Sud</a></span>
