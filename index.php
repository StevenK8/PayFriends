        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Projet Devleoppement Web 2019 - Polytech Paris-Sud  <a href="http://www.polytech.u-psud.fr/fr/index.html" target="_blank">Polytech</a></span>
